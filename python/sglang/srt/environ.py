...
class Envs:
    ...
    SGLANG_USE_PCIE_CUSTOM_ALL_REDUCE = EnvBool(False)
    SGLANG_PCIE_AR_CONFIG_DIR = EnvStr(None)
    SGLANG_PCIE_AR_SOURCE_PATH = EnvStr(None)
    SGLANG_PCIE_AR_BUILD_DIR = EnvStr(None)
    SGLANG_PCIE_AR_MAX_SIZE_BYTES = EnvInt(8 * 1024 * 1024)
    SGLANG_PCIE_AR_MAX_BLOCKS = EnvInt(128)
    SGLANG_PCIE_AR_ENABLE_PDL = EnvBool(False)
    SGLANG_PCIE_AR_VERBOSE_BUILD = EnvBool(False)
