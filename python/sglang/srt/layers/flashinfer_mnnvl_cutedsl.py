    ...
    def __init__(
        ...
        *,
        ...
        with torch.cuda.device(self.device):
            ...
            # Workspace construction compiles kernels and initializes mutable
            # communication state asynchronously. Publish it only after every
            # TP rank has finished local initialization.
