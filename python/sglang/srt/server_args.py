    ...
    def check_server_args(self):
        ...
        if self.speculative_algorithm is not None and self.enable_mixed_chunk:
            ...
            assert (
                ...
                and self.enable_linear_replayssm_spec
            ), (
                "Mixed chunked prefill with speculative decoding is supported "
                "only for Qwen3.5 EAGLE/NextN with topk=1 and ReplaySSM spec enabled."
            )
